...
@RestController
@RequestMapping("/api/posts-kafka")
public class PostsKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PostsKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PostsKafkaResource(KafkaProperties kafkaProperties) {
